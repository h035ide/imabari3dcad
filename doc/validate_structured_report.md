# structured_api 検証ログ (2025-09-29 01:59:09)
...
- XMLエントリ数: 93
- JSONエントリ数: 82
- XMLのみ: 11件 / JSONのみ: 0件 / 差分: 82件

## レポート
```
[XMLのみ]BracketParam, CreateNURBSCurve, CreateVariable, FacePlateParam, LinearSweepParam, LoftParam, ProfileParam, RotationalSweepParam, STLParameter, SlotParam, SweepParam
[差分]
