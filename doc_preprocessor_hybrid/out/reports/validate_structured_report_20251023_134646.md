# structured_api 検証ログ (2025-10-23 13:46:46)
...
## レポート
```
[XMLのみ]BracketParam, FacePlateParam, LinearSweepParam, LoftParam, ProfileParam, RotationalSweepParam, STLParameter, SlotParam, SweepParam, オペレーションタイプ
