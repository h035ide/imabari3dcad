...
class ScriptAnalyzer:
    ...
    def analyze_script(self, script_path: str, script_text: str) -> Tuple[List[Dict[str, Any]], Dict[str, Dict[str, Any]]]:
        """
        ...
        try:
            ...
            for i, call in enumerate(method_calls):
                ...
                # データフロー解析
                self._analyze_data_flow(call, call_node_id, variable_to_source_call_id, triples)
            ...
            logger.info(f"スクリプト解析完了: {script_path} - トリプル数={len(triples)}")
    ...
    def _analyze_data_flow(self, call: Dict[str, Any], call_node_id: str, 
