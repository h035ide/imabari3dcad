...
from .config import _load_yaml_config, OPENAI_API_KEY, NEO4J_URI, NEO4J_USER, NEO4J_PASSWORD, NEO4J_DATABASE
...
class RAGQueryApp:
    ...
    def run_ingestion(self) -> None:
        ...
        try:
            ...
            progress_logger.info("📊 Neo4j: ノード=%d件, リレーション=%d件", node_count, rel_count)
    ...
    def _init_components(self) -> None:
        ...
        try:
            ...
            chroma_persist_dir = Path(self.config.get("paths", {}).get("chroma_persist_dir", "data/chroma_db"))
