...
class ResponseGenerator:
    ...
    def generate_response(self, query: str, 
                         ...
                         vector_results: List[Dict[str, Any]]) -> QueryResponse:
        """
        検索結果を統合してレスポンスを生成する
    ...
    def _integrate_results(self, graph_results: List[Dict[str, Any]], 
        ...
        for result in vector_results:
            integrated_result = {
                ...
                "relevance_score": 1.0 - result.get("similarity_score", 0.5)  # スコアを逆転
            }
            integrated.append(integrated_result)
